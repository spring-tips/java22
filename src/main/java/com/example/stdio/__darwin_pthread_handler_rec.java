...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        stdio_h.C_POINTER.withName("__routine"),
        stdio_h.C_POINTER.withName("__arg"),
        stdio_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = stdio_h.upcallHandle(__routine.Function.class, "apply", $DESC);
